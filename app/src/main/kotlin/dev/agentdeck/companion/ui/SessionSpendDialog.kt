        ...
        Surface(
            ...
            Column(Modifier.padding(top = 24.dp, bottom = 12.dp)) {
                Column(Modifier.padding(horizontal = 24.dp)) {
                    Text("Chat spend limits", style = MaterialTheme.typography.headlineSmall)
                ...
                Column(
                    ...
                    if (form == null) {
                        ...
                        Form(form, editable = !sheet.busy, refused = sheet.refused, onForm = onForm)
                    }
...
@Composable
private fun Form(form: SpendForm, editable: Boolean, refused: String?, onForm: (SpendForm) -> Unit) {
    Row(
