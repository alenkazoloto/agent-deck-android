 ...
 * [viewportHeight] re-reveals the match when the list shrinks after the scroll: the keyboard
 * slides in on its own clock, and a match revealed at the bottom edge ended under the composer.
 */
@OptIn(ExperimentalFoundationApi::class)
@Composable
fun ConversationFindPassage(
    turn: MobileTurn,
    ...
    LaunchedEffect(match, layout, reveal, viewportHeight) {
