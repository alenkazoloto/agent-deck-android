...
internal object DeckIcons {
    val Minus = ImageVector.Builder("Minus", 24.dp, 24.dp, 24f, 24f).apply {
        path(fill = SolidColor(Color.Black)) {
            moveTo(5f, 11f); horizontalLineTo(19f); verticalLineTo(13f); horizontalLineTo(5f); close()
        }
    }.build()
    ...
    /** Two overlapping sheets: make a copy of this one. */
    val Duplicate = ImageVector.Builder("Duplicate", 24.dp, 24.dp, 24f, 24f).apply {
        path(fill = SolidColor(Color.Black)) {
            moveTo(8f, 3f); horizontalLineTo(20f); verticalLineTo(17f); horizontalLineTo(8f); close()
            moveTo(10f, 5f); verticalLineTo(15f); horizontalLineTo(18f); verticalLineTo(5f); close()
            moveTo(4f, 7f); horizontalLineTo(6f); verticalLineTo(19f); horizontalLineTo(16f)
            verticalLineTo(21f); horizontalLineTo(4f); close()
        }
    }.build()
    /** Put aside: an arrow into a tray, the composer stash's action. */
    val Stash = ImageVector.Builder("Stash", 24.dp, 24.dp, 24f, 24f).apply {
        path(fill = SolidColor(Color.Black)) {
            moveTo(3f, 13f); horizontalLineTo(5f); verticalLineTo(19f); horizontalLineTo(19f)
            verticalLineTo(13f); horizontalLineTo(21f); verticalLineTo(21f); horizontalLineTo(3f); close()
            moveTo(11f, 3f); horizontalLineTo(13f); verticalLineTo(10f); horizontalLineTo(17f)
            lineTo(12f, 16f); lineTo(7f, 10f); horizontalLineTo(11f); close()
        }
    }.build()
}
