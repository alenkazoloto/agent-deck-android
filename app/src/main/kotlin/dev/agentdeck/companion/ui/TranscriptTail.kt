...
object TranscriptTail {
    ...
    /** Seeing the top of a long final answer is not reading its newest words. */
    fun atEnd(lastVisible: Int, total: Int, lastBottom: Int, viewportEnd: Int, tolerance: Int): Boolean =
        total == 0 || (lastVisible == total - 1 && lastBottom <= viewportEnd + tolerance)
