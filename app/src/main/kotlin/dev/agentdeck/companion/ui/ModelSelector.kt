...
fun ModelSelector(
    ...
    /**
     * What the pill says before its value. Defaults to naming itself, because the dialogs that
     * draw it have no room for headings; the new-chat screen passes "Model:" to match its row.
     */
    prefix: String? = "Model",
) {
