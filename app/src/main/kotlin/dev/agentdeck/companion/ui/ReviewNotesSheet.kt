...
fun NoteEditorSheet(
    ...
    ModalBottomSheet(onDismissRequest = onDismiss, sheetState = rememberModalBottomSheetState(skipPartiallyExpanded = true)) {
        Column(
            ...
            Text(if (editor.noteId == null) "Add review note" else "Edit review note", style = MaterialTheme.typography.titleMedium)
            Text(
            ...
            if (editor.noteId == null && editor.following.isNotEmpty()) {
            ...
            Row(
                ...
                Button(onClick = onSave, enabled = editor.canSave, modifier = Modifier.testTag("note-save")) { Text("Save") }
            }
        }
    }
}
