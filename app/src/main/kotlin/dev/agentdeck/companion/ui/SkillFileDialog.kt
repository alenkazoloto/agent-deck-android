...
/**
 * Resources › Skills, agents and plugins › a skill's, command's or subagent's "Edit file": the desk's "Open SKILL.md" and subagent "Open file" as text on one full-screen
        ...
        Surface(Modifier.fillMaxSize().testTag("skill-file-dialog"), color = MaterialTheme.colorScheme.surface) {
            Column(Modifier.fillMaxSize().statusBarsPadding().navigationBarsPadding().imePadding()) {
                ...
                when {
                    ...
                    else -> FileNotice("skill-file", "Reading the file…")
                }
            }
        }
    }
...
internal const val SKILL_FILE_READ_ONLY =
    "Read only: saving skill and subagent files from this phone is off. Turn it on for this phone in the IDE, under Settings › Connections › Mobile › Devices."
