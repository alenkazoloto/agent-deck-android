...
object Navigation {
    ...
    /**
     * Whether the bottom bar can carry its words. From the system's 1.5× text size up, "Workspace"
     * no longer fits a quarter of a 360 dp phone and broke mid-word ("Worksp/ace"). The labels go
     * rather than shrink: each icon keeps its name for TalkBack, and the top bar already titles
     * the current destination (PLAN-MOBILE-REDESIGN J14).
     */
    fun labelsBar(fontScale: Float): Boolean = fontScale <= 1.3f
