...
sealed interface Screen {
    ...
    /**
     * What this machine has spent and what its plans still allow. Opened *from* Settings and
     * keeps a back arrow, like Conversation and New chat: it is a page of one destination, not
     * a fourth destination — a bottom-bar tab for a screen read once a week would cost the
     * three that are read constantly a quarter of their width.
     */
 ...
 * wider layouts retain the navigation rail.
 */
...
object Navigation {
    ...
    fun needsHello(screen: Screen): Boolean = when (screen) {
        Screen.Scheduled, Screen.Settings, Screen.Usage -> true
        else -> false
    }
