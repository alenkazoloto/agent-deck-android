...
/**
 * One answer for the `@` popup: the machine's files, then its git and past-chat rows, as the
 * desk's popup merges them. [indexing] speaks for [paths] only — git and chats need no index.
 */
data class MentionMatches(
    val paths: List<String> = emptyList(),
    val context: List<MobileMentionRow> = emptyList(),
