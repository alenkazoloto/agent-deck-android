...
data class ConversationOutline(
    ...
    companion object {
         ...
         * it. The activity row wears the turn's [MobileTurn.groupTitle] when it has one, as the
         * bubble's group header does. A turn that is neither — a system note, an empty streaming placeholder —
