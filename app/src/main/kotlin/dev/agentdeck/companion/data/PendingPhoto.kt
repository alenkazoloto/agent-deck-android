...
object TextFileAttachment {
    ...
    fun refusal(bytes: ByteArray): String? = when {
        ...
        !MobileAttachment.looksLikeText(bytes) -> "That file is not UTF-8 text — only photos and text files can be attached"
        else -> null
    }
