...
object TextFileAttachment {
    ...
    fun refusal(bytes: ByteArray, pdfSupported: Boolean = false, zipSupported: Boolean = false, gzipSupported: Boolean = false, tarSupported: Boolean = false, xzSupported: Boolean = false): String? = when {
        bytes.isEmpty() -> "That file is empty or could not be read"
