...
data class AppSettings(
    ...
    /**
     * How a file's diff is laid out under Changes. Both off by default: a phone is narrow, and
     * a wrapped line and a line-number gutter each cost the column the code is in. They are
     * settings rather than a control on the diff itself because the answer is a reading habit,
     * not a per-file decision — and a toggle on every file is a toggle in the way of every file.
     */
