...
class BridgeClient internal constructor(
    ...
    /** `GET /v1/preview?project=[&frame=1]` — the desk's Preview state and, when asked, one picture of the page. */
    fun preview(project: String, frame: Boolean): MobilePreviewView =
        MobilePreviewView.fromJson(get(MobilePreviewAction.ROUTE + "?project=" + URLEncoder.encode(project, "UTF-8") + if (frame) "&frame=1" else ""))
