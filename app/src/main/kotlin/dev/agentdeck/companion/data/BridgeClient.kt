...
class BridgeClient internal constructor(
    ...
    /** `GET /v1/review/{key}/revert` — what reverting this conversation's files to its start would do. */
    fun revertPreview(key: String): MobileReviewRevertPreview = MobileReviewRevertPreview.fromJson(
        get("/v1/review/" + URLEncoder.encode(key, "UTF-8") + "/" + MobileReviewRevertRequest.SUFFIX),
    )
