...
class BridgeClient internal constructor(
     ...
     * `&request=` for that request's own change of the file.
     */
    fun reviewFile(key: String, path: String, request: String? = null): MobileReviewFileDiff = MobileReviewFileDiff.fromJson(
        get(
