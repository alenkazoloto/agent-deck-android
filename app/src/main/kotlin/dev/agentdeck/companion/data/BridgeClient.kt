...
class BridgeClient internal constructor(
    ...
    /**
     * `POST /v1/attach` — one re-encoded JPEG, one UTF-8 text file, one PDF, one ZIP archive, one gzip file, one tar archive, one xz file, one bzip2 file or one Zstandard file ([contentType]), each at its own cap.
     *
