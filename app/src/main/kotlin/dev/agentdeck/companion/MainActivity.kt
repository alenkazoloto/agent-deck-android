...
private fun ScreenHost(state: DeckState, model: DeckViewModel) {
    ...
    AnimatedContent(
        ...
        when (screen) {
            ...
            val feedbackChips = MobileProtocol.Capability.REVIEW_FEEDBACK_CHIPS in state.hello?.capabilities.orEmpty()
            ...
            CompositionLocalProvider(LocalMarkdownImages provides imageLoader) { ConversationScreen(
                ...
                onOpenReviewFile = { path, request -> model.openReviewFile(screen.key, path, request) },
