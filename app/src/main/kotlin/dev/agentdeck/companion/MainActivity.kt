    ...
    AnimatedContent(
        ...
        when (screen) {
            ...
            Screen.NewChat -> {
                ...
                (DeckFixtureHook.paintedWorktreeSheet ?: worktreeSheet)?.let { sheet ->
                    WorktreeSheetView(
                        sheet,
