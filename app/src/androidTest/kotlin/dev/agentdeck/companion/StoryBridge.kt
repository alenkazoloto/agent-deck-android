    ...
    init {
        ...
        server.dispatcher = object : Dispatcher() {
            override fun dispatch(request: RecordedRequest): MockResponse {
                ...
                return when {
                    path == "/v1/hello" -> json(requireNotNull(fleetFixture.hello).let { it.copy(capabilities = it.capabilities + MobileProtocol.Capability.SCHEDULE_EDIT + MobileProtocol.Capability.ANSWER + if (paging) setOf(MobileProtocol.Capability.TRANSCRIPT_PAGING) else emptySet()) }.toJson())
