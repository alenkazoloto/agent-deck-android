...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "settings-usage", "settings-keep-awake", "settings-keep-awake-off", "settings-new-chat-mode", "usage", "usage-unmeasured", "usage-limit", "usage-spend-defaults", "usage-spend-defaults-sheet", "scheduled-after-reset", "convo-limit",
