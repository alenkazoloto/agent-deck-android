...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip` and `attachment-gzip` — so the paperclip is the photo-or-file menu.
            ...
            state.copy(
                hello = HELLO.copy(
                    capabilities = HELLO.capabilities +
                        ...
                        MobileProtocol.Capability.ATTACHMENT_GZIP,
                ),
