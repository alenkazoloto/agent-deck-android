...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "convo-changes", "convo-changes-scope", "convo-changes-scope-diff", "convo-changes-diff", "convo-commit", "convo-commit-failed", "convo-commit-unsupported", "convo-revert", "convo-revert-failed", "convo-revert-list", "convo-revert-request", "convo-revert-after", "convo-notes-files", "convo-notes-diff", "convo-notes-list", "convo-notes-editor", "convo-notes-chips", "convo-queued", "convo-composer-attachments",
