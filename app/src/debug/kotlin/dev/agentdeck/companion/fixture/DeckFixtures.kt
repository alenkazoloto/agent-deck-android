...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip`, `attachment-gzip`, `attachment-tar` and `attachment-xz` — so the paperclip is the photo-or-file menu.
            ...
            state.copy(
                hello = HELLO.copy(
                    capabilities = HELLO.capabilities +
                        ...
                        MobileProtocol.Capability.ATTACHMENT_GZIP + MobileProtocol.Capability.ATTACHMENT_TAR + MobileProtocol.Capability.ATTACHMENT_XZ,
                ),
