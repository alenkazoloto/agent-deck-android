...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        "convo-acp" -> conversation(vendor = AgentVendor.CLAUDE, running = false, toolResults = true).let { base ->
            base.copy(
    ...
    fun names(): List<String> = listOf(
        ...
        "settings-usage", "settings-keep-awake", "settings-keep-awake-off", "usage", "usage-unmeasured", "usage-limit", "scheduled-after-reset", "convo-limit",
