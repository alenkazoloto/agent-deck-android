...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        "convo-ai-review", "convo-ai-review-running", "convo-ai-review-findings", "convo-working-diff", "convo-working-diff-patch" -> conversation(vendor = AgentVendor.CODEX, running = false).let { state ->
    ...
    fun names(): List<String> = listOf(
        ...
        "new-chat-run-options", "new-chat-worktree", "new-chat-worktree-failed", "new-chat-worktree-unsupported", "new-chat-worktrees-button", "new-chat-worktrees", "new-chat-worktrees-remove", "new-chat-worktrees-request", "new-chat-worktrees-link", "new-chat-worktrees-review-button", "new-chat-worktrees-review-github", "new-chat-worktrees-review-gitlab", "new-chat-worktrees-review-none", "new-chat-worktrees-review-edit-request", "new-chat-worktrees-review-edit-comment", "new-chat-worktrees-review-bitbucket", "new-chat-worktrees-review-files", "new-chat-repository-button", "new-chat-repository-clone", "new-chat-repository-publish", "new-chat-repository-cloned", "convo-composer-pills", "convo-waiting", "convo-questions-multi", "convo-tool-results",
        "convo-changes", "convo-changes-scope", "convo-changes-scope-diff", "convo-changes-base", "convo-changes-base-diff", "convo-changes-whitespace", "convo-changes-whitespace-on", "convo-changes-sort", "convo-changes-grouped", "convo-changes-diff", "convo-commit", "convo-commit-failed", "convo-commit-unsupported", "convo-revert", "convo-revert-failed", "convo-revert-list", "convo-revert-request", "convo-revert-after", "convo-notes-files", "convo-notes-diff", "convo-notes-list", "convo-notes-editor", "convo-notes-chips", "convo-queued", "convo-composer-attachments",
        ...
        "convo-ai-review", "convo-ai-review-running", "convo-ai-review-findings", "convo-working-diff", "convo-working-diff-patch",
