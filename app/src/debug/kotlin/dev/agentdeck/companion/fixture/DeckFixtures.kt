...
object DeckFixtures {
    ...
    fun worktreeSheet(name: String): dev.agentdeck.companion.data.WorktreeSheet? {
        if (name != "new-chat-worktrees" && name != "new-chat-worktrees-remove") return null
        ...
        return if (name == "new-chat-worktrees") sheet
        else sheet.copy(confirm = dev.agentdeck.companion.data.WorktreeConfirm(fleet.rows.first(), com.github.claudeagents.core.mobile.MobileWorktreeActionRequest.REMOVE, "main"))
    }
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        "new-chat-worktrees-button", "new-chat-worktrees", "new-chat-worktrees-remove" -> newChat().let { state ->
    ...
    fun names(): List<String> = listOf(
        ...
        "new-chat-run-options", "new-chat-worktree", "new-chat-worktree-failed", "new-chat-worktree-unsupported", "new-chat-worktrees-button", "new-chat-worktrees", "new-chat-worktrees-remove", "convo-composer-pills", "convo-waiting", "convo-questions-multi", "convo-tool-results",
