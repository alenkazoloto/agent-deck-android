...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip`, `attachment-gzip` and `attachment-tar` — so the paperclip is the photo-or-file menu.
            ...
            state.copy(
                hello = HELLO.copy(
                    capabilities = HELLO.capabilities +
                        ...
                        MobileProtocol.Capability.ATTACHMENT_GZIP + MobileProtocol.Capability.ATTACHMENT_TAR,
                ),
    ...
    fun names(): List<String> = listOf(
        ...
        "convo-permission", "convo-permission-off", "convo-plan", "convo-plan-off", "convo-goal", "convo-subagents", "convo-recap", "convo-retry", "convo-claude", "convo-codex", "convo-truncated", "convo-whole", "convo-idle",
