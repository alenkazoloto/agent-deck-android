...
object DeckFixtures {
    ...
    fun worktreeSheet(name: String): dev.agentdeck.companion.data.WorktreeSheet? {
        if (name !in setOf("new-chat-worktrees", "new-chat-worktrees-remove", "new-chat-worktrees-request", "new-chat-worktrees-link")) return null
    ...
    fun names(): List<String> = listOf(
        ...
        "new-chat-run-options", "new-chat-worktree", "new-chat-worktree-failed", "new-chat-worktree-unsupported", "new-chat-worktrees-button", "new-chat-worktrees", "new-chat-worktrees-remove", "new-chat-worktrees-request", "new-chat-worktrees-link", "convo-composer-pills", "convo-waiting", "convo-questions-multi", "convo-tool-results",
