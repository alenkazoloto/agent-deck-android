...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "new-chat-run-options", "new-chat-worktree", "new-chat-worktree-failed", "new-chat-worktree-unsupported", "convo-composer-pills", "convo-waiting", "convo-questions-multi", "convo-tool-results",
