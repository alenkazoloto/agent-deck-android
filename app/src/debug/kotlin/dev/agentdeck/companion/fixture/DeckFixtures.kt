...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        "new-chat-worktrees-review-edit-request", "new-chat-worktrees-review-edit-comment", "new-chat-worktrees-review-bitbucket" -> newChat().let { state ->
            state.copy(
                hello = HELLO.copy(
