...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "settings-usage", "settings-keep-awake", "settings-keep-awake-off", "settings-keep-awake-review", "settings-prompt-suggestions", "settings-restricted-mode", "settings-questions-keep-working", "settings-continue-interrupted", "settings-auto-review", "settings-new-chat-mode", "usage", "usage-unmeasured", "usage-limit", "usage-spend-defaults", "usage-spend-defaults-sheet", "usage-export", "usage-set-active", "usage-account-edit", "scheduled-after-reset", "convo-limit",
