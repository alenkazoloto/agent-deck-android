...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip`, `attachment-gzip`, `attachment-tar`, `attachment-xz`, `attachment-bzip2` and `attachment-zstd` — so the paperclip is the photo-or-file menu.
            ...
            state.copy(
                hello = HELLO.copy(
                    capabilities = HELLO.capabilities +
                        ...
                        MobileProtocol.Capability.ATTACHMENT_ZSTD,
                ),
