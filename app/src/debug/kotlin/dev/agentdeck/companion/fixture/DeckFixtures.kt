...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "settings-usage", "settings-keep-awake", "settings-keep-awake-off", "settings-keep-awake-review", "settings-prompt-suggestions", "settings-restricted-mode", "settings-new-chat-mode", "usage", "usage-unmeasured", "usage-limit", "usage-spend-defaults", "usage-spend-defaults-sheet", "usage-export", "usage-set-active", "scheduled-after-reset", "convo-limit",
