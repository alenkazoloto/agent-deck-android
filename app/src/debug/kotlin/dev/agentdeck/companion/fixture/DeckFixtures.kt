...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        "convo-subagents" -> conversation(vendor = AgentVendor.CLAUDE, running = true).let {
            it.copy(transcript = it.transcript!!.copy(subagents = 3))
        }
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip`, `attachment-gzip`, `attachment-tar`, `attachment-xz`, `attachment-bzip2`, `attachment-zstd` and `attachment-7z` — so the paperclip is the photo-or-file menu.
            ...
            state.copy(
                hello = HELLO.copy(
                    capabilities = HELLO.capabilities +
                        ...
                        MobileProtocol.Capability.ATTACHMENT_ZSTD + MobileProtocol.Capability.ATTACHMENT_7Z,
                ),
    ...
    fun names(): List<String> = listOf(
        ...
        "convo-permission", "convo-permission-off", "convo-plan", "convo-plan-off", "convo-goal", "convo-subagents", "convo-recap", "convo-suggestion", "convo-retry", "convo-claude", "convo-codex", "convo-truncated", "convo-whole", "convo-idle",
        ...
        "scheduled", "scheduled-no-create", "scheduled-reset", "scheduled-edit-toggles", "scheduled-edit-plain", "settings", "settings-two-machines",
        ...
        "settings-usage", "settings-keep-awake", "settings-keep-awake-off", "settings-new-chat-mode", "usage", "usage-unmeasured", "usage-limit", "usage-spend-defaults", "usage-spend-defaults-sheet", "usage-set-active", "scheduled-after-reset", "convo-limit",
