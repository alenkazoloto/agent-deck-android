...
object DeckFixtures {
    ...
    fun byName(name: String): DeckState? = when (name) {
        ...
        // that advertises `attachment-text`, `attachment-pdf`, `attachment-zip`, `attachment-gzip`, `attachment-tar`, `attachment-xz` and `attachment-bzip2` — so the paperclip is the photo-or-file menu.
