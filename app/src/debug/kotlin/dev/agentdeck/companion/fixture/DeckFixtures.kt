...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "convo-permission", "convo-permission-off", "convo-plan", "convo-plan-off", "convo-goal", "convo-subagents", "convo-subagent-thread", "convo-recap", "convo-suggestion", "convo-retry", "convo-claude", "convo-codex", "convo-truncated", "convo-whole", "convo-idle",
