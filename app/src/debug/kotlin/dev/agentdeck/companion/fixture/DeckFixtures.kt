...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "convo-changes", "convo-changes-diff", "convo-commit", "convo-commit-failed", "convo-commit-unsupported", "convo-revert", "convo-revert-failed", "convo-revert-list", "convo-queued", "convo-composer-attachments",
