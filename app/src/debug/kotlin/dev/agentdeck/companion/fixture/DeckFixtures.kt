...
object DeckFixtures {
    ...
    fun names(): List<String> = listOf(
        ...
        "fleet-organized", "fleet-organized-done", "fleet-message-search",
    )
    ...
    private fun organized(scope: FleetScope): DeckState = fleet(backlog = 4, sort = FleetSort.RECENT).let { state ->
        ...
        state.copy(
            ...
            hello = HELLO.copy(capabilities = HELLO.capabilities + MobileProtocol.Capability.SESSION_ACTIONS + MobileProtocol.Capability.SESSION_EXPORT),
