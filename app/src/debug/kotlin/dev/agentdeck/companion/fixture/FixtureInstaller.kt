...
class FixtureInstaller : ContentProvider() {
    ...
    override fun onCreate(): Boolean {
        ...
        DeckFixtureHook.sessionMcp = DeckFixtures::sessionMcpSheet
        DeckFixtureHook.sessionCodex = DeckFixtures::sessionCodexSheet
        DeckFixtureHook.memory = DeckFixtures::memorySheet
        DeckFixtureHook.skills = DeckFixtures::skillsList
        DeckFixtureHook.sideQuestion = DeckFixtures::sideQuestionSheet
