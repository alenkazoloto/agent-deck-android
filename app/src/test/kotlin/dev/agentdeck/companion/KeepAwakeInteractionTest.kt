...
class KeepAwakeInteractionTest {
    ...
    private fun show(keepAwake: Boolean?, holdForReview: Boolean? = null) = compose.setContent {
        AgentDeckTheme(dark = false, dynamic = false) {
            SettingsScreen(
                state = DeckFixtures.byName("settings")!!.copy(keepAwake = keepAwake, holdForReview = holdForReview),
                onSettings = {},
                onSwitchMachine = {},
                onAddMachine = {},
                onUnpair = {},
