...
class KeepAwakeInteractionTest {
    ...
    private fun show(keepAwake: Boolean?, holdForReview: Boolean? = null, promptSuggestions: Boolean? = null) = compose.setContent {
        AgentDeckTheme(dark = false, dynamic = false) {
            SettingsScreen(
                state = DeckFixtures.byName("settings")!!.copy(keepAwake = keepAwake, holdForReview = holdForReview, promptSuggestions = promptSuggestions),
                onSettings = {},
                onSwitchMachine = {},
                onAddMachine = {},
                onUnpair = {},
