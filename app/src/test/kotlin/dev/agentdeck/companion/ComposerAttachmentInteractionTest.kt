...
class ComposerAttachmentInteractionTest {
    ...
    @Test
    fun `a machine that takes xz files but not PDFs, archives, gzip or tar also calls the file item File`() {
        show(capabilities = listOf(MobileProtocol.Capability.ATTACHMENTS, MobileProtocol.Capability.ATTACHMENT_TEXT, MobileProtocol.Capability.ATTACHMENT_XZ))
    ...
    @Test
    fun `a machine that takes bzip2 files but not PDFs, archives, gzip, tar or xz also calls the file item File`() {
        show(capabilities = listOf(MobileProtocol.Capability.ATTACHMENTS, MobileProtocol.Capability.ATTACHMENT_TEXT, MobileProtocol.Capability.ATTACHMENT_BZIP2))
    ...
    @Test
    fun `a machine that takes Zstandard files but not PDFs, archives, gzip, tar, xz or bzip2 also calls the file item File`() {
        show(capabilities = listOf(MobileProtocol.Capability.ATTACHMENTS, MobileProtocol.Capability.ATTACHMENT_TEXT, MobileProtocol.Capability.ATTACHMENT_ZSTD))
    ...
    @Test
    fun `a machine that takes 7z archives but not PDFs, archives, gzip, tar, xz, bzip2 or Zstandard also calls the file item File`() {
        show(capabilities = listOf(MobileProtocol.Capability.ATTACHMENTS, MobileProtocol.Capability.ATTACHMENT_TEXT, MobileProtocol.Capability.ATTACHMENT_7Z))
    ...
    @Test
    fun `a machine that takes RAR archives but not PDFs, archives, gzip, tar, xz, bzip2, Zstandard or 7z also calls the file item File`() {
        show(capabilities = listOf(MobileProtocol.Capability.ATTACHMENTS, MobileProtocol.Capability.ATTACHMENT_TEXT, MobileProtocol.Capability.ATTACHMENT_RAR))
