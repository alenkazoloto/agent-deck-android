...
class McpInteractionTest {
    ...
    private fun show(capable: Boolean = true, answer: suspend (String?) -> MobileMcpServers?) {
        val base = DeckFixtures.byName("settings")!!
        val state = if (capable) {
            base.copy(hello = base.hello!!.copy(capabilities = base.hello!!.capabilities + MobileProtocol.Capability.MCP_SERVERS))
        } else {
            base
        }
        compose.setContent {
