...
class TextFileAttachTest {
    ...
    private class Upload(val contentType: String?, val body: ByteArray)
    ...
    private fun fakeBridge() = BridgeClient(listOf("machine.test"), 8443, "00", "token") { url ->
        object : HttpsURLConnection(url) {
            ...
            override fun getResponseCode(): Int {
                if (url.path.endsWith(MobileAttachment.ROUTE)) uploads += Upload(getRequestProperty("Content-Type"), body.toByteArray())
