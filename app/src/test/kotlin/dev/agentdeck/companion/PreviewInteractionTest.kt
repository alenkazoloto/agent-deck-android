...
class PreviewInteractionTest {
    ...
    private fun state(open: Boolean = true, unavailable: String? = null, canScroll: Boolean = true, canInteract: Boolean = false, canDrag: Boolean = canInteract) = MobilePreviewState(
    ...
    private fun picture(canScroll: Boolean = true, canInteract: Boolean = false, canDrag: Boolean = canInteract) =
        MobilePreviewView(state(canScroll = canScroll, canInteract = canInteract, canDrag = canDrag), MobilePreviewFrame(++rev, 390, 300, jpeg()))
