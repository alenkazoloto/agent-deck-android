...
android {
    ...
    defaultConfig {
        ...
        // 6/"1.5" was skipped: a v1.5 release already existed on the mirror at versionCode 6,
        // published from a tree that never committed the bump, so republishing at 6 would have
        // been invisible to every phone that already had it.
        versionCode = 7
        versionName = "1.6"
